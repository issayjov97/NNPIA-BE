...
INSERT INTO posts (id, title, type, category_id, description, details, user_id) VALUES (9, 'Vegetarische Küche', 'SKILLS', 1, 'Ich bin gelernte Köchin, habe aber nach meiner Ausbildung vorwiegend im Service und nicht in der Küche gearbeitet.', null, 1);
